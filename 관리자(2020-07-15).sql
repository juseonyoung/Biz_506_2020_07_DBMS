...
-- grade 사용자가 DB를 조작할 수 있도록 권한을 부여한다.
-- 권한은 세부적으로 부여하는 것이 좋지만 실습의 편의성을 위해서 DBA권한을 부여함
-- GRANT :권한을 부여하겠다
